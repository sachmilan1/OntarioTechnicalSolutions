...
```
java -cp ./src/main/java FileSharingClientGUI
```

This assumes that Java and Git are properly installed on your machine. If not, please install both before attempting to run the project.
